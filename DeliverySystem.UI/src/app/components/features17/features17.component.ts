...
export class Features17 {
  ...
  feature1ImageAlt: string =
    'Побудова найопитимальнішого маршруту для доставки допомоги. Волонтерам не потрібно думати, куди краще їхати, щоб встигнути у всі міста, за них це зробить наша платформа!'
  @Input()
  feature1Title: string = 'Побудова маршруту'
  @Input()
